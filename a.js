...
var ASM_CONSTS = {
 ...
 93702: () => { return Module.canvas.width; },  
 93734: () => { return parseInt(Module.canvas.style.width); },  
 93782: () => { document.exitFullscreen(); },  
 93809: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 93882: () => { if (document.fullscreenElement) return 1; },  
 93928: () => { return Module.canvas.width; },  
 93960: () => { return screen.width; },  
 93985: () => { document.exitFullscreen(); },  
 94012: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 94145: () => { return window.innerWidth; },  
 94171: () => { return window.innerHeight; },  
 94198: () => { if (document.fullscreenElement) return 1; },  
 94244: () => { return Module.canvas.width; },  
 94276: () => { return parseInt(Module.canvas.style.width); },  
 94324: () => { if (document.fullscreenElement) return 1; },  
 94370: () => { return Module.canvas.width; },  
 94402: () => { return screen.width; },  
 94427: () => { return window.innerWidth; },  
 94453: () => { return window.innerHeight; },  
 94480: () => { if (document.fullscreenElement) return 1; },  
 94526: () => { return Module.canvas.width; },  
 94558: () => { return screen.width; },  
 94583: () => { document.exitFullscreen(); },  
 94610: () => { if (document.fullscreenElement) return 1; },  
 94656: () => { return Module.canvas.width; },  
 94688: () => { return parseInt(Module.canvas.style.width); },  
 94736: () => { document.exitFullscreen(); },  
 94763: ($0) => { Module.canvas.style.opacity = $0; },  
 94801: () => { return screen.width; },  
 94826: () => { return screen.height; },  
 94852: () => { return window.screenX; },  
 94879: () => { return window.screenY; },  
 94906: () => { return window.devicePixelRatio; },  
 94942: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 94995: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 95046: () => { Module.canvas.style.cursor = 'none'; },  
 95083: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 95339: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 95390: () => { if (document.pointerLockElement) return 1; },  
 95437: () => { if (document.fullscreenElement) return 1; },  
 95483: () => { return window.innerWidth; },  
 95509: () => { return window.innerHeight; }
};
